      ...
      <div className="p-5 cursor-pointer" onClick={onToggle}>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p
              className={`text-sm text-slate-500 dark:text-slate-400 mt-1.5 leading-relaxed transition-all ${isExpanded ? "" : "line-clamp-1"}`}
            >
              {item.description}
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <span
              className={`hidden sm:flex items-center gap-1.5 px-2 py-0.5 rounded-full text-xs font-medium border ${priorityStyles[item.priority]}`}
            >
